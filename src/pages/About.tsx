            ...
            {teamMembers.map((member) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-solar-blue mb-2">{member.role}</p>
              ...
              <div className="space-y-4 mt-8">
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-solar-lightgray p-3 rounded-full mr-4">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6 text-solar-darkblue"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">CR-22 Rimms building</p>
                    <p className="text-gray-600">NUST-h12 sector Islamabad</p>
                  </div>
                </div>
              </div>
            </div>
