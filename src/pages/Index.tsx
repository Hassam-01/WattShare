          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl mb-8 text-white/90">
                Join the largest marketplace for solar panels, batteries, inverters and complete systems. Save money and help the planet.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our marketplace connects buyers and sellers of solar equipment, helping you save money and reduce your carbon footprint.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-solar-lightgray p-6 rounded-lg text-center">
              ...
              <p className="text-gray-600">
                All sellers go through our verification process to ensure quality and reliability.
              </p>
            </div>
            ...
            <div className="bg-solar-lightgray p-6 rounded-lg text-center">
              ...
              <p className="text-gray-600">
                Extending the life of solar products reduces waste and maximizes environmental benefits.
              </p>
            </div>
            ...
            <div className="bg-solar-lightgray p-6 rounded-lg text-center">
              ...
              <p className="text-gray-600">
                Find great deals on new and used solar equipment at prices below retail.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Find exactly what you need in our comprehensive selection of solar energy products.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="relative group overflow-hidden rounded-lg h-64">
              <img
                src="https://images.unsplash.com/photo-1592833167344-45da5d8c3c61?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                alt="Solar Panels"
                className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                <div className="p-4 w-full">
                  <h3 className="text-white text-xl font-bold mb-1">Solar Panels</h3>
                  <Link to="/explore?category=panels" className="text-solar-yellow flex items-center">
            ...
            <div className="relative group overflow-hidden rounded-lg h-64">
              <img
                src="https://images.unsplash.com/photo-1564252420929-ab513ad75d6b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                alt="Batteries"
                className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                <div className="p-4 w-full">
                  <h3 className="text-white text-xl font-bold mb-1">Batteries</h3>
                  <Link to="/explore?category=batteries" className="text-solar-yellow flex items-center">
                    Browse <ArrowRight className="ml-1 h-4 w-4" />
                  </Link>
                </div>
              </div>
            ...
            <div className="relative group overflow-hidden rounded-lg h-64">
              <img
                src="https://images.unsplash.com/photo-1559302995-f1d7d5127265?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                alt="Inverters"
                className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                <div className="p-4 w-full">
                  <h3 className="text-white text-xl font-bold mb-1">Inverters</h3>
                  <Link to="/explore?category=inverters" className="text-solar-yellow flex items-center">
                    Browse <ArrowRight className="ml-1 h-4 w-4" />
                  </Link>
                </div>
              </div>
            ...
            <div className="relative group overflow-hidden rounded-lg h-64">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end">
                <div className="p-4 w-full">
                  <h3 className="text-white text-xl font-bold mb-1">Complete Systems</h3>
                  <Link to="/explore?category=systems" className="text-solar-yellow flex items-center">
                    Browse <ArrowRight className="ml-1 h-4 w-4" />
                  </Link>
                </div>
              </div>
      ...
      <section className="bg-gradient-to-r from-primary to-secondary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto text-white/90">
            Whether you're looking to buy or sell solar equipment, WattShare makes it easy and secure.
          </p>
